...
import com.aditya.blogexplorer.detail.DetailViewModel
import com.aditya.blogexplorer.edit.EditActivity
import com.aditya.blogexplorer.R
import com.aditya.blogexplorer.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val postId = intent.getIntExtra(EXTRA_ID, -1)
